...
//	public final CANSparkMax talonBallShooter = new CANSparkMax(1, MotorType.kBrushless);
  ...
  */
	...
	public final AnalogInput highReedSwitch = new AnalogInput(2);
	...
	/**
	 * Returns the only robotMap object that exists in the code.
	 */
	...
	/**
	 * Some default settings for the talons
	 * @param talon that is being configured
	 */
	...
	/**
	 * Creates a deadzone on the controler, where the joysticks don't have any effect.
	 * @param input joystick value
	 * @return joystick value or 0
	 */

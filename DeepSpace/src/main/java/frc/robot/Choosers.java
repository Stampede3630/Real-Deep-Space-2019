...
public class Choosers
{
    ...
    /**
     * Logic for adjusting angles for autonomous functions (180° difference between Hatch and Cargo)
     * @param angle for adjustment
     * @return adjusted angle for current manipulator
     */
    ...
    /**
     * Rotates the robot towards a selected angle if autonomous rotation is enabled
     * @param angle from the path selecting widget
     */
    ...
    /**
     * Observes the controller buttons and switches between semi-autonomous and teleOp
     */
...
*/
    ...
    /**
     * Compares current manipulator with selected manipulator on the widget and switches to the selected one.
     */
...
//            if(currentManipulator.equals("Ball"))
    ...
    /**
     * Switches between driver and vision processing pipelines based on the controller buttons
     */
